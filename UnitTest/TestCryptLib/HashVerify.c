...
GLOBAL_REMOVE_IF_UNREFERENCED CONST UINT8 Sha3_Shake256Digest[SHAKE256_DIGEST_SIZE] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED CONST UINT8 Sm3_256Digest[SM3_256_DIGEST_SIZE] = {
