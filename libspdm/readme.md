...
1) [mbedtls](https://tls.mbed.org) as Crypto library
   ...
   Rename mbedtls-2.16.6 to mbedtls and put mbedtls under [mbedtlslib](https://github.com/jyao1/openspdm/tree/master/libspdm/os_stub/mbedtlslib)
...
2) [openssl](https://www.openssl.org) as crypto library
   ...
   Rename openssl-1.1.1g to openssl and put openssl under [openssllib](https://github.com/jyao1/openspdm/tree/master/libspdm/os_stub/openssllib)
