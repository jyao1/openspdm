  ...
  )
{
  ...
  spdm_set_connection_state (spdm_context, SPDM_CONNECTION_STATE_NOT_STARTED);
  ...
  *response_size = sizeof(spdm_version_response) + spdm_context->local_context.version.spdm_version_count * sizeof(spdm_version_number_t);
  ...
  spdm_response->version_number_entry_count = spdm_context->local_context.version.spdm_version_count;
  copy_mem (spdm_response->version_number_entry, spdm_context->local_context.version.spdm_version, sizeof(spdm_version_number_t) * spdm_context->local_context.version.spdm_version_count);
  ...
  spdm_context->connection_info.version.spdm_version_count = spdm_context->local_context.version.spdm_version_count;
  copy_mem (spdm_context->connection_info.version.spdm_version, spdm_context->local_context.version.spdm_version, sizeof(spdm_version_number_t) * spdm_context->local_context.version.spdm_version_count);

  spdm_set_connection_state (spdm_context, SPDM_CONNECTION_STATE_AFTER_VERSION);
