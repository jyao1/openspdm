  ...
  )
{
  ...
  final_data_size = spdm_get_opaque_data_supported_version_data_size (spdm_context);
  ...
  opaque_element_table_header->opaque_element_data_len = sizeof(secured_message_opaque_element_supported_version_t) + sizeof(spdm_version_number_t);

  opaque_element_support_version = (void *)(opaque_element_table_header + 1);
  opaque_element_support_version->sm_data_version = SECURED_MESSAGE_OPAQUE_ELEMENT_SMDATA_DATA_VERSION;
  opaque_element_support_version->sm_data_id = SECURED_MESSAGE_OPAQUE_ELEMENT_SMDATA_ID_SUPPORTED_VERSION;
  ...
  )
{
  ...
  if (data_in_size != spdm_get_opaque_data_supported_version_data_size (spdm_context)) {
  ...
  opaque_element_support_version = (void *)(opaque_element_table_header + 1);
  if ((opaque_element_support_version->sm_data_version != SECURED_MESSAGE_OPAQUE_ELEMENT_SMDATA_DATA_VERSION) ||
      (opaque_element_support_version->sm_data_id != SECURED_MESSAGE_OPAQUE_ELEMENT_SMDATA_ID_SUPPORTED_VERSION) ||
      (opaque_element_support_version->version_count != 1) ) {
    return RETURN_UNSUPPORTED;
  }
  ...
  )
{
  ...
  secured_message_general_opaque_data_table_header_t   *general_opaque_data_table_header;
  secured_message_opaque_element_table_header_t        *opaque_element_table_header;
  secured_message_opaque_element_version_selection_t   *OpaqueElementVersionSection;
  void                                               *end;
  ...
  final_data_size = spdm_get_opaque_data_version_selection_data_size (spdm_context);
  if (*data_out_size < final_data_size) {
    *data_out_size = final_data_size;
    return RETURN_BUFFER_TOO_SMALL;
  }
  ...
  opaque_element_table_header->id = SPDM_REGISTRY_ID_DMTF;
  opaque_element_table_header->vendor_len = 0;
  opaque_element_table_header->opaque_element_data_len = sizeof(secured_message_opaque_element_version_selection_t);

  OpaqueElementVersionSection = (void *)(opaque_element_table_header + 1);
  OpaqueElementVersionSection->sm_data_version = SECURED_MESSAGE_OPAQUE_ELEMENT_SMDATA_DATA_VERSION;
  OpaqueElementVersionSection->sm_data_id = SECURED_MESSAGE_OPAQUE_ELEMENT_SMDATA_ID_VERSION_SELECTION;
  ...
  )
{
  ...
  if (data_in_size != spdm_get_opaque_data_version_selection_data_size (spdm_context)) {
    return RETURN_UNSUPPORTED;
  }
  general_opaque_data_table_header = data_in;
  if ((general_opaque_data_table_header->spec_id != SECURED_MESSAGE_OPAQUE_DATA_SPEC_ID) ||
  ...
  OpaqueElementVersionSection = (void *)(opaque_element_table_header + 1);
  if ((OpaqueElementVersionSection->sm_data_version != SECURED_MESSAGE_OPAQUE_ELEMENT_SMDATA_DATA_VERSION) ||
      (OpaqueElementVersionSection->sm_data_id != SECURED_MESSAGE_OPAQUE_ELEMENT_SMDATA_ID_VERSION_SELECTION) ||
      (OpaqueElementVersionSection->selected_version.minor_version != 1) ||
      (OpaqueElementVersionSection->selected_version.major_version != 1) ) {
    return RETURN_UNSUPPORTED;
