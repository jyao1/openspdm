...
uintn m_spdm_get_measurements_request3_size = sizeof(m_spdm_get_measurements_request3) - sizeof(uint8);
...
uintn m_spdm_get_measurements_request5_size = sizeof(m_spdm_get_measurements_request5) - sizeof(uint8);
...
uintn m_spdm_get_measurements_request8_size = sizeof(m_spdm_get_measurements_request8) - sizeof(uint8);
...
uintn m_spdm_get_measurements_request10_size = sizeof(m_spdm_get_measurements_request10);
...
uintn m_spdm_get_measurements_request11_size = sizeof(m_spdm_get_measurements_request11);
...
uintn m_spdm_get_measurements_request12_size = sizeof(m_spdm_get_measurements_request12);
...
void test_spdm_responder_measurements_case1(void **state) {
  ...
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request1.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request1_size, &m_spdm_get_measurements_request1, &response_size, response);
  ...
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, m_spdm_get_measurements_request1_size + sizeof(spdm_measurements_response_t) + sizeof(uint16));
}
...
void test_spdm_responder_measurements_case2(void **state) {
  ...
  response_size = sizeof(response);
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request2.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request2_size, &m_spdm_get_measurements_request2, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
...
void test_spdm_responder_measurements_case5(void **state) {
  ...
  spdm_response = (void *)response;
  error_data = (spdm_error_data_response_not_ready_t*)(&spdm_response->number_of_blocks);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
...
void test_spdm_responder_measurements_case7(void **state) {
  ...
  response_size = sizeof(response);
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request5.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request5_size, &m_spdm_get_measurements_request5, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
...
void test_spdm_responder_measurements_case8(void **state) {
  ...
  measurment_sig_size = SPDM_NONCE_SIZE + sizeof(uint16) + 0 + spdm_get_asym_signature_size (m_use_asym_algo);
  response_size = sizeof(response);
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request3.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request3_size, &m_spdm_get_measurements_request3, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + measurment_sig_size);
  spdm_response = (void *)response;
  assert_int_equal (spdm_response->header.request_response_code, SPDM_MEASUREMENTS);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, 0);
}
...
void test_spdm_responder_measurements_case9(void **state) {
  ...
  response_size = sizeof(response);
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request4.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request4_size, &m_spdm_get_measurements_request4, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
...
void test_spdm_responder_measurements_case10(void **state) {
  ...
  response_size = sizeof(response);
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request6.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request6_size, &m_spdm_get_measurements_request6, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16));
  spdm_response = (void *)response;
  assert_int_equal (spdm_response->header.request_response_code, SPDM_MEASUREMENTS);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, m_spdm_get_measurements_request6_size + sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16));
}
...
void test_spdm_responder_measurements_case11(void **state) {
  ...
  response_size = sizeof(response);
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request8.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request8_size, &m_spdm_get_measurements_request8, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_measurements_response_t) + (MEASUREMENT_BLOCK_NUMBER - 1) * (sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo)) + (sizeof(spdm_measurement_block_dmtf_t) + MEASUREMENT_MANIFEST_SIZE) + measurment_sig_size);
  spdm_response = (void *)response;
  assert_int_equal (spdm_response->header.request_response_code, SPDM_MEASUREMENTS);  
  assert_int_equal (spdm_response->number_of_blocks, MEASUREMENT_BLOCK_NUMBER);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, 0);
}
...
void test_spdm_responder_measurements_case12(void **state) {
  ...
  response_size = sizeof(response);
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request7.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request7_size, &m_spdm_get_measurements_request7, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_measurements_response_t) + (MEASUREMENT_BLOCK_NUMBER - 1) * (sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo)) + (sizeof(spdm_measurement_block_dmtf_t) + MEASUREMENT_MANIFEST_SIZE) + sizeof(uint16));
  spdm_response = (void *)response;
  assert_int_equal (spdm_response->header.request_response_code, SPDM_MEASUREMENTS);
  assert_int_equal (spdm_response->number_of_blocks, MEASUREMENT_BLOCK_NUMBER);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, m_spdm_get_measurements_request7_size + sizeof(spdm_measurements_response_t) + (MEASUREMENT_BLOCK_NUMBER - 1) * (sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo)) + (sizeof(spdm_measurement_block_dmtf_t) + MEASUREMENT_MANIFEST_SIZE) + sizeof(uint16));
}
...
void test_spdm_responder_measurements_case13(void **state) {
  ...
  TestMsgSizes[0] = (uint16)(m_spdm_get_measurements_request9_size + sizeof(m_spdm_get_measurements_request9.SlotIDParam) + sizeof(m_spdm_get_measurements_request9.nonce));
  TestMsgSizes[1] = (uint16)(m_spdm_get_measurements_request9_size + sizeof(m_spdm_get_measurements_request9.SlotIDParam));
  TestMsgSizes[2] = (uint16)(m_spdm_get_measurements_request9_size + sizeof(m_spdm_get_measurements_request9.nonce));
  ...
  spdm_context->local_context.capability.flags |= SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MEAS_CAP_NO_SIG;
  spdm_context->connection_info.algorithm.bash_hash_algo = m_use_hash_algo;
  spdm_context->connection_info.algorithm.base_asym_algo = m_use_asym_algo;
  spdm_context->connection_info.algorithm.measurement_hash_algo = m_use_measurement_hash_algo;
  ...
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request9.nonce);
  for(int i=0; i<sizeof(TestMsgSizes)/sizeof(TestMsgSizes[0]); i++) {
    response_size = sizeof(response);
    status = spdm_get_response_measurements (spdm_context, TestMsgSizes[i], &m_spdm_get_measurements_request9, &response_size, response);
    assert_int_equal (status, RETURN_SUCCESS);
    assert_int_equal (response_size, sizeof(spdm_error_response_t));
    spdm_response = (void *)response;
    assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
...
void test_spdm_responder_measurements_case14(void **state) {
  ...
  TestMsgSizes[0] = (uint16)(m_spdm_get_measurements_request10_size - sizeof(m_spdm_get_measurements_request10.SlotIDParam) - sizeof(m_spdm_get_measurements_request10.nonce));
  TestMsgSizes[1] = (uint16)(m_spdm_get_measurements_request10_size - sizeof(m_spdm_get_measurements_request10.SlotIDParam));
  TestMsgSizes[2] = (uint16)(m_spdm_get_measurements_request10_size - sizeof(m_spdm_get_measurements_request10.nonce));
  ...
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request10.nonce);
  for(int i=0; i<sizeof(TestMsgSizes)/sizeof(TestMsgSizes[0]); i++) {
    response_size = sizeof(response);
    status = spdm_get_response_measurements (spdm_context, TestMsgSizes[i], &m_spdm_get_measurements_request10, &response_size, response);
    assert_int_equal (status, RETURN_SUCCESS);
    assert_int_equal (response_size, sizeof(spdm_error_response_t));
    spdm_response = (void *)response;
    assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
...
void test_spdm_responder_measurements_case15(void **state) {
  ...
  response_size = sizeof(response);
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request10.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request10_size, &m_spdm_get_measurements_request10, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
...
void test_spdm_responder_measurements_case16(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request9_size, &m_spdm_get_measurements_request10, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
...
void test_spdm_responder_measurements_case17(void **state) {
  ...
  response_size = sizeof(response);
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request9.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request9_size, &m_spdm_get_measurements_request9, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_UNSUPPORTED_REQUEST);
  assert_int_equal (spdm_response->header.param2, m_spdm_get_measurements_request10.header.request_response_code);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, 0);
}
...
void test_spdm_responder_measurements_case18(void **state) {
  ...
  response_size = sizeof(response);
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request11.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request11_size, &m_spdm_get_measurements_request11, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + measurment_sig_size);
  spdm_response = (void *)response;
  assert_int_equal (spdm_response->header.request_response_code, SPDM_MEASUREMENTS);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, 0);
  assert_int_equal (m_spdm_get_measurements_request11.SlotIDParam, spdm_response->header.param2);
...
void test_spdm_responder_measurements_case19(void **state) {
  ...
  response_size = sizeof(response);
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request12.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request12_size, &m_spdm_get_measurements_request12, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
...
void test_spdm_responder_measurements_case21(void **state) {
  ...
  response_size = sizeof(response);
  spdm_get_random_number (SPDM_NONCE_SIZE, m_spdm_get_measurements_request13.nonce);
  status = spdm_get_response_measurements (spdm_context, m_spdm_get_measurements_request13_size, &m_spdm_get_measurements_request13, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
...
void test_spdm_responder_measurements_case22(void **state) {
  ...
  for (NumberOfMessages = 1; NumberOfMessages <= TOTAL_MESSAGES; NumberOfMessages++) {
    ...
    if (spdm_response->header.request_response_code == SPDM_MEASUREMENTS) {
      assert_int_equal (spdm_response->header.request_response_code, SPDM_MEASUREMENTS);
      assert_int_equal (response_size, sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16));
      assert_int_equal (spdm_context->transcript.message_m.buffer_size, NumberOfMessages*(m_spdm_get_measurements_request6_size + sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16)));
    } else {
      assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
      assert_int_equal (spdm_context->transcript.message_m.buffer_size, 0);
      break;
...
int spdm_responder_measurements_test_main(void) {
  ...
  return cmocka_run_group_tests(spdm_responder_measurements_tests, spdm_unit_test_group_setup, spdm_unit_test_group_teardown);
}
