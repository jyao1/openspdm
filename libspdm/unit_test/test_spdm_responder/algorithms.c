...
uintn m_spdm_negotiate_algorithms_request1_size = sizeof(m_spdm_negotiate_algorithms_request1);
...
void test_spdm_responder_algorithms_case1(void **state) {
  ...
  status = spdm_get_response_algorithms (spdm_context, m_spdm_negotiate_algorithms_request1_size, &m_spdm_negotiate_algorithms_request1, &response_size, response);
...
void test_spdm_responder_algorithms_case2(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_algorithms (spdm_context, m_spdm_negotiate_algorithms_request2_size, &m_spdm_negotiate_algorithms_request2, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
...
void test_spdm_responder_algorithms_case5(void **state) {
  ...
  spdm_response = (void *)response;
  error_data = (spdm_error_data_response_not_ready_t*)(&spdm_response->length);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
...
int spdm_responder_algorithms_test_main(void) {
  ...
  return cmocka_run_group_tests(spdm_responder_algorithms_tests, spdm_unit_test_group_setup, spdm_unit_test_group_teardown);
}
