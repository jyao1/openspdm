...
uintn m_spdm_get_capabilities_request3_size = sizeof(m_spdm_get_capabilities_request3);
...
uintn m_spdm_get_capabilities_request4_size = sizeof(m_spdm_get_capabilities_request4);
...
uintn m_spdm_get_capabilities_request5_size = sizeof(m_spdm_get_capabilities_request5);
...
uintn m_spdm_get_capabilities_request6_size = sizeof(m_spdm_get_capabilities_request6);
...
uintn m_spdm_get_capabilities_request7_size = sizeof(m_spdm_get_capabilities_request7);
...
uintn m_spdm_get_capabilities_request8_size = sizeof(m_spdm_get_capabilities_request8);
...
uintn m_spdm_get_capabilities_request9_size = sizeof(m_spdm_get_capabilities_request9);
...
uintn m_spdm_get_capabilities_request10_size = sizeof(m_spdm_get_capabilities_request10);
...
uintn m_spdm_get_capabilities_request11_size = sizeof(m_spdm_get_capabilities_request11);
...
uintn m_spdm_get_capabilities_request12_size = sizeof(m_spdm_get_capabilities_request12);
...
uintn m_spdm_get_capabilities_request13_size = sizeof(m_spdm_get_capabilities_request13);
...
uintn m_spdm_get_capabilities_request14_size = sizeof(m_spdm_get_capabilities_request14);
...
uintn m_spdm_get_capabilities_request15_size = sizeof(m_spdm_get_capabilities_request15);
...
uintn m_spdm_get_capabilities_request16_size = sizeof(m_spdm_get_capabilities_request16);
...
uintn m_spdm_get_capabilities_request17_size = sizeof(m_spdm_get_capabilities_request17);
...
uintn m_spdm_get_capabilities_request18_size = sizeof(m_spdm_get_capabilities_request18);
...
void test_spdm_responder_capabilities_case1(void **state) {
  ...
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request1_size, &m_spdm_get_capabilities_request1, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_capabilities_response));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request1.header.spdm_version, spdm_response->header.spdm_version);
...
void test_spdm_responder_capabilities_case2(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request2_size, &m_spdm_get_capabilities_request2, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request2.header.spdm_version, spdm_response->header.spdm_version);
...
void test_spdm_responder_capabilities_case5(void **state) {
  ...
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request1.header.spdm_version, spdm_response->header.spdm_version);
  error_data = (spdm_error_data_response_not_ready_t*)(&spdm_response->reserved);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
...
void test_spdm_responder_capabilities_case7(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request3_size, &m_spdm_get_capabilities_request3, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request3.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_INVALID_REQUEST);
  assert_int_equal (spdm_response->header.param2, 0);
}
...
void test_spdm_responder_capabilities_case8(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request4_size, &m_spdm_get_capabilities_request4, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_capabilities_response));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request4.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_CAPABILITIES);
}
...
void test_spdm_responder_capabilities_case9(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request5_size, &m_spdm_get_capabilities_request5, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_capabilities_response));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request4.header.spdm_version, spdm_response->header.spdm_version);
...
void test_spdm_responder_capabilities_case10(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request6_size, &m_spdm_get_capabilities_request6, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request6.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_INVALID_REQUEST);
  assert_int_equal (spdm_response->header.param2, 0);
}
...
void test_spdm_responder_capabilities_case11(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request7_size, &m_spdm_get_capabilities_request7, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request7.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_INVALID_REQUEST);
  assert_int_equal (spdm_response->header.param2, 0);
}
...
void test_spdm_responder_capabilities_case12(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request8_size, &m_spdm_get_capabilities_request8, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_capabilities_response));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request4.header.spdm_version, spdm_response->header.spdm_version);
...
void test_spdm_responder_capabilities_case13(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request9_size, &m_spdm_get_capabilities_request9, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request9.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_INVALID_REQUEST);
  assert_int_equal (spdm_response->header.param2, 0);
}
...
void test_spdm_responder_capabilities_case14(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request10_size, &m_spdm_get_capabilities_request10, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request10.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_INVALID_REQUEST);
  assert_int_equal (spdm_response->header.param2, 0);
}
...
void test_spdm_responder_capabilities_case15(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request11_size, &m_spdm_get_capabilities_request11, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request11.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_INVALID_REQUEST);
  assert_int_equal (spdm_response->header.param2, 0);
}
...
void test_spdm_responder_capabilities_case16(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request12_size, &m_spdm_get_capabilities_request12, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request12.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_INVALID_REQUEST);
  assert_int_equal (spdm_response->header.param2, 0);
}
...
void test_spdm_responder_capabilities_case17(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request13_size, &m_spdm_get_capabilities_request13, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request13.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_INVALID_REQUEST);
  assert_int_equal (spdm_response->header.param2, 0);
}
...
void test_spdm_responder_capabilities_case18(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request14_size, &m_spdm_get_capabilities_request14, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request14.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_INVALID_REQUEST);
  assert_int_equal (spdm_response->header.param2, 0);
}
...
void test_spdm_responder_capabilities_case19(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request15_size, &m_spdm_get_capabilities_request15, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request15.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_INVALID_REQUEST);
  assert_int_equal (spdm_response->header.param2, 0);
}
...
void test_spdm_responder_capabilities_case20(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request16_size, &m_spdm_get_capabilities_request16, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request16.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_INVALID_REQUEST);
  assert_int_equal (spdm_response->header.param2, 0);
}
...
void test_spdm_responder_capabilities_case21(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request17_size, &m_spdm_get_capabilities_request17, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_error_response_t));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request17.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_ERROR);
  assert_int_equal (spdm_response->header.param1, SPDM_ERROR_CODE_INVALID_REQUEST);
  assert_int_equal (spdm_response->header.param2, 0);
}
...
void test_spdm_responder_capabilities_case22(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_capabilities (spdm_context, m_spdm_get_capabilities_request18_size, &m_spdm_get_capabilities_request18, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (response_size, sizeof(spdm_capabilities_response));
  spdm_response = (void *)response;
  assert_int_equal (m_spdm_get_capabilities_request18.header.spdm_version, spdm_response->header.spdm_version);
  assert_int_equal (spdm_response->header.request_response_code, SPDM_CAPABILITIES);
}
...
int spdm_responder_capabilities_test_main(void) {
  ...
  return cmocka_run_group_tests(spdm_responder_capabilities_tests, spdm_unit_test_group_setup, spdm_unit_test_group_teardown);
}
