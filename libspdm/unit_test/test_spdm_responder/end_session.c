...
void test_spdm_responder_end_session_case1(void **state) {
  ...
  status = spdm_get_response_end_session (spdm_context, m_spdm_end_session_request1_size, &m_spdm_end_session_request1, &response_size, response);
...
void test_spdm_responder_end_session_case2(void **state) {
  ...
  response_size = sizeof(response);
  status = spdm_get_response_end_session (spdm_context, m_spdm_end_session_request2_size, &m_spdm_end_session_request2, &response_size, response);
  assert_int_equal (status, RETURN_SUCCESS);
...
int spdm_responder_end_session_test_main(void) {
  ...
  return cmocka_run_group_tests(spdm_responder_end_session_tests, spdm_unit_test_group_setup, spdm_unit_test_group_teardown);
}
