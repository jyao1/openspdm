  ...
  )
{
  ...
  copy_mem (secured_message_context->handshake_secret.response_handshake_encryption_key, key, secured_message_context->aead_key_size);
}
  ...
  )
{
  ...
  copy_mem (secured_message_context->handshake_secret.response_handshake_salt, salt, secured_message_context->aead_iv_size);
}
...
int spdm_requester_psk_finish_test_main(void) {
  ...
  return cmocka_run_group_tests(spdm_requester_psk_finish_tests, spdm_unit_test_group_setup, spdm_unit_test_group_teardown);
}
