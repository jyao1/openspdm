  ...
  )
{
  ...
  case 0xa:
  {
    ...
    spdm_response.header.param2 = 0;
    spdm_response.ct_exponent = 0;
    spdm_response.flags = (SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_CACHE_CAP |
  ...
  case 0xe:
  {
    ...
    spdm_transport_test_encode_message (spdm_context, NULL, FALSE, FALSE, sizeof(spdm_response)+sizeof(uint8), &spdm_response, response_size, response);
  }
    return RETURN_DEVICE_ERROR;
    ...
    case 0x10:
    {
      ...
      spdm_response.header.param2 = 0;
      spdm_response.ct_exponent = 0;
      spdm_response.flags = DEFAULT_CAPABILITY_RESPONSE_FLAG_VERSION_11;
    ...
    case 0x11:
    {
      ...
      spdm_response.header.param2 = 0;
      spdm_response.ct_exponent = 0;
      spdm_response.flags = DEFAULT_CAPABILITY_RESPONSE_FLAG_VERSION_11 & (0xFFFFFFFF^(SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_KEY_EX_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_PSK_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_HANDSHAKE_IN_THE_CLEAR_CAP));
    ...
    case 0x12:
    {
      ...
      spdm_response.header.param2 = 0;
      spdm_response.ct_exponent = 0;
      spdm_response.flags = DEFAULT_CAPABILITY_RESPONSE_FLAG_VERSION_11 & (0xFFFFFFFF^(SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MAC_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_KEY_EX_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_PSK_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_HANDSHAKE_IN_THE_CLEAR_CAP));
    ...
    case 0x13:
    {
      ...
      spdm_response.header.param2 = 0;
      spdm_response.ct_exponent = 0;
      spdm_response.flags = DEFAULT_CAPABILITY_RESPONSE_FLAG_VERSION_11 & (0xFFFFFFFF^(SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_ENCRYPT_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_KEY_EX_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_PSK_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_HANDSHAKE_IN_THE_CLEAR_CAP));
      spdm_transport_test_encode_message (spdm_context, NULL, FALSE, FALSE, sizeof(spdm_response), &spdm_response, response_size, response);
    }
      return RETURN_SUCCESS;
    ...
    case 0x14:
    {
      ...
      spdm_response.header.param2 = 0;
      spdm_response.ct_exponent = 0;
      spdm_response.flags = DEFAULT_CAPABILITY_RESPONSE_FLAG_VERSION_11 & (0xFFFFFFFF^(SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_ENCRYPT_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MAC_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_HANDSHAKE_IN_THE_CLEAR_CAP));
    ...
    case 0x15:
    {
      ...
      spdm_response.header.param2 = 0;
      spdm_response.ct_exponent = 0;
      spdm_response.flags = DEFAULT_CAPABILITY_RESPONSE_FLAG_VERSION_11 & (0xFFFFFFFF^(SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_ENCRYPT_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MAC_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_PSK_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_HANDSHAKE_IN_THE_CLEAR_CAP));
    ...
    case 0x16:
    {
      ...
      spdm_response.header.param2 = 0;
      spdm_response.ct_exponent = 0;
      spdm_response.flags = DEFAULT_CAPABILITY_RESPONSE_FLAG_VERSION_11 & (0xFFFFFFFF^(SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_ENCRYPT_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MAC_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_KEY_EX_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_HANDSHAKE_IN_THE_CLEAR_CAP));
    ...
    case 0x17:
    {
      ...
      spdm_response.header.param2 = 0;
      spdm_response.ct_exponent = 0;
      spdm_response.flags = DEFAULT_CAPABILITY_RESPONSE_FLAG_VERSION_11 & (0xFFFFFFFF^(SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_ENCAP_CAP));
    ...
    case 0x18:
    {
      ...
      spdm_response.header.param2 = 0;
      spdm_response.ct_exponent = 0;
      spdm_response.flags = DEFAULT_CAPABILITY_RESPONSE_FLAG_VERSION_11 & (0xFFFFFFFF^(SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_KEY_EX_CAP));
    ...
    case 0x19:
    {
      ...
      spdm_response.header.param2 = 0;
      spdm_response.ct_exponent = 0;
      spdm_response.flags = DEFAULT_CAPABILITY_RESPONSE_FLAG_VERSION_11 & (0xFFFFFFFF^(SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_ENCRYPT_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MAC_CAP | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_PSK_CAP));
    ...
    case 0x1a:
    {
      ...
      spdm_response.header.param2 = 0;
      spdm_response.ct_exponent = 0;
      spdm_response.flags = DEFAULT_CAPABILITY_RESPONSE_FLAG_VERSION_11 | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_PUB_KEY_ID_CAP;
...
void test_spdm_requester_get_capabilities_case10(void **state) {
  ...
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (spdm_context->connection_info.capability.ct_exponent, 0);
  assert_int_equal (spdm_context->connection_info.capability.flags, (SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_CACHE_CAP |
                                     SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_CERT_CAP |
                                     SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_CHAL_CAP |
                                     SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MEAS_CAP_SIG |
                                     SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MEAS_FRESH_CAP));
...
void test_spdm_requester_get_capabilities_case12(void **state) {
  ...
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (spdm_context->connection_info.capability.ct_exponent, 0);
  assert_int_equal (spdm_context->connection_info.capability.flags, SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MEAS_FRESH_CAP);
}
...
void test_spdm_requester_get_capabilities_case16(void **state) {
  ...
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (spdm_context->connection_info.capability.ct_exponent, 0);
  assert_int_equal (spdm_context->connection_info.capability.flags, DEFAULT_CAPABILITY_RESPONSE_FLAG_VERSION_11);
}
...
int spdm_requester_get_capabilities_test_main(void) {
  ...
  setup_spdm_test_context (&m_spdm_requester_get_capabilities_test_context);

  return cmocka_run_group_tests(m_spdm_requester_get_capabilities_tests, spdm_unit_test_group_setup, spdm_unit_test_group_teardown);
}
