...
void test_spdm_requester_negotiate_algorithms_case10(void **state) {
  ...
  spdm_context->connection_info.capability.flags |= SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MEAS_CAP_NO_SIG;
  spdm_context->transcript.message_a.buffer_size = 0;
...
void test_spdm_requester_negotiate_algorithms_case12(void **state) {
  ...
  status = spdm_negotiate_algorithms (spdm_context);
  assert_int_equal (status, RETURN_SECURITY_VIOLATION);
  assert_int_equal (spdm_context->connection_info.algorithm.bash_hash_algo, 0);
}
...
int spdm_requester_negotiate_algorithms_test_main(void) {
  const struct CMUnitTest spdm_requester_negotiate_algorithms_tests[] = {
      // SendRequest failed
      cmocka_unit_test(test_spdm_requester_negotiate_algorithms_case1),
      // Successful response
      cmocka_unit_test(test_spdm_requester_negotiate_algorithms_case2),
      // connection_state check failed
      cmocka_unit_test(test_spdm_requester_negotiate_algorithms_case3),
      // Error response: SPDM_ERROR_CODE_INVALID_REQUEST
      cmocka_unit_test(test_spdm_requester_negotiate_algorithms_case4),
      // Always SPDM_ERROR_CODE_BUSY
      cmocka_unit_test(test_spdm_requester_negotiate_algorithms_case5),
      // SPDM_ERROR_CODE_BUSY + Successful response
      cmocka_unit_test(test_spdm_requester_negotiate_algorithms_case6),
      // Error response: SPDM_ERROR_CODE_REQUEST_RESYNCH
      cmocka_unit_test(test_spdm_requester_negotiate_algorithms_case7),
      // Always SPDM_ERROR_CODE_RESPONSE_NOT_READY
      cmocka_unit_test(test_spdm_requester_negotiate_algorithms_case8),
      // SPDM_ERROR_CODE_RESPONSE_NOT_READY + Successful response
      cmocka_unit_test(test_spdm_requester_negotiate_algorithms_case9),
      // When spdm_response.measurement_hash_algo is 0
      cmocka_unit_test(test_spdm_requester_negotiate_algorithms_case10),
      // When spdm_response.base_asym_sel is 0
      cmocka_unit_test(test_spdm_requester_negotiate_algorithms_case11),
      // When spdm_response.base_hash_sel is 0
      cmocka_unit_test(test_spdm_requester_negotiate_algorithms_case12),
  };
  
  setup_spdm_test_context (&m_spdm_requester_negotiate_algorithms_test_context);

  return cmocka_run_group_tests(spdm_requester_negotiate_algorithms_tests, spdm_unit_test_group_setup, spdm_unit_test_group_teardown);
}
