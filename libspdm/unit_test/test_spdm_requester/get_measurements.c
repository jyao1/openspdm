...
uintn
spdm_test_get_measurement_request_size (
  ...
  )
{
  ...
  if (spdm_request->header.param1 == SPDM_GET_MEASUREMENTS_REQUEST_ATTRIBUTES_GENERATE_SIGNATURE) {
    if (spdm_is_version_supported (spdm_context, SPDM_MESSAGE_VERSION_11)) {
      ...
      if (buffer_size < sizeof(spdm_get_measurements_request_t) - sizeof(spdm_request->SlotIDParam)) {
        return buffer_size;
      }
      message_size = sizeof(spdm_get_measurements_request_t) - sizeof(spdm_request->SlotIDParam);
    }
  } else {
  ...
  )
{
  ...
  case 0x2:
    ...
    message_size = spdm_test_get_measurement_request_size (spdm_context, (uint8 *)request + header_size, request_size - header_size);
  ...
  )
{
  ...
  case 0x2:
  {
    ...
    temp_buf_size = sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + measurment_sig_size;
    ...
    spdm_write_uint24 (spdm_response->measurement_record_length, (uint32)(sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo)));
    measurment_block = (void *)(spdm_response + 1);
    set_mem (measurment_block, sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo), 1);
    measurment_block->Measurement_block_common_header.measurement_specification = SPDM_MEASUREMENT_BLOCK_HEADER_SPECIFICATION_DMTF;
    measurment_block->Measurement_block_common_header.measurement_size = (uint16) (sizeof(spdm_measurement_block_dmtf_header_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo));
    ptr = (void *)((uint8 *)spdm_response + temp_buf_size - measurment_sig_size);
  ...
  case 0xA:
  {
    ...
    temp_buf_size = sizeof(spdm_measurements_response_t) + sizeof(uint16);
    spdm_response = (void *)temp_buf;
    spdm_response->header.spdm_version = SPDM_MESSAGE_VERSION_10;
    spdm_response->header.request_response_code = SPDM_MEASUREMENTS;
    ...
    *(uint16 *)((uint8 *)spdm_response + sizeof(spdm_measurements_response_t)) = 0;
  ...
  case 0xB:
  {
    ...
    ((spdm_context_t*)spdm_context)->connection_info.algorithm.measurement_hash_algo = m_use_measurement_hash_algo;
    temp_buf_size = sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16);
    spdm_response = (void *)temp_buf;
    ...
    measurment_block->Measurement_block_common_header.measurement_specification = SPDM_MEASUREMENT_BLOCK_HEADER_SPECIFICATION_DMTF;
    measurment_block->Measurement_block_common_header.measurement_size = (uint16) (sizeof(spdm_measurement_block_dmtf_header_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo));
    *(uint16 *)((uint8 *)spdm_response + sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo)) = 0;
  ...
  case 0xE:
  {
    ...
    ((spdm_context_t*)spdm_context)->connection_info.algorithm.bash_hash_algo = m_use_hash_algo;
    ((spdm_context_t*)spdm_context)->connection_info.algorithm.measurement_hash_algo = m_use_measurement_hash_algo;
    temp_buf_size = sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo);
    spdm_response = (void *)temp_buf;
  ...
  case 0x12:
  {
    ...
    temp_buf = (uint8*) malloc(sizeof(spdm_measurements_response_t) + LARGE_MEASUREMENT_SIZE);
    ...
    spdm_write_uint24 (spdm_response->measurement_record_length, (uint32)(LARGE_MEASUREMENT_SIZE));
    measurment_block = (void *)(spdm_response + 1);
    set_mem (measurment_block, LARGE_MEASUREMENT_SIZE, 1);
    for (count = 0; count < spdm_response->number_of_blocks; count++) {
      measurment_block->Measurement_block_common_header.index = (uint8)(count + 1);
      measurment_block->Measurement_block_common_header.measurement_specification = SPDM_MEASUREMENT_BLOCK_HEADER_SPECIFICATION_DMTF;
      measurment_block->Measurement_block_common_header.measurement_size = MAX_UINT16;
      temp_buf_size += (uintn)(sizeof(spdm_measurement_block_common_header_t) + MAX_UINT16);
    }
    status = spdm_transport_test_encode_message (spdm_context, NULL, FALSE, FALSE, temp_buf_size, temp_buf, response_size, response);
  ...
  case 0x13:
  {
    ...
    measurment_block->Measurement_block_common_header.measurement_specification = BIT0 | BIT1;
    measurment_block->Measurement_block_common_header.measurement_size = (uint16) (sizeof(spdm_measurement_block_dmtf_header_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo));
  ...
  case 0x14:
  {
    ...
    set_mem (measurment_block, sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo), 1);
    measurment_block->Measurement_block_common_header.index = 1;
    measurment_block->Measurement_block_common_header.measurement_specification = BIT2 | BIT1;
    measurment_block->Measurement_block_common_header.measurement_size = (uint16) (sizeof(spdm_measurement_block_dmtf_header_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo));
  ...
  case 0x15:
  {
    ...
    set_mem (measurment_block, sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo), 1);
    measurment_block->Measurement_block_common_header.index = 1;
    measurment_block->Measurement_block_common_header.measurement_specification = (uint8)(m_use_measurement_spec<<1);
    measurment_block->Measurement_block_common_header.measurement_size = (uint16) (sizeof(spdm_measurement_block_dmtf_header_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo));
  ...
  case 0x17:
  {
    ...
    ((spdm_context_t*)spdm_context)->connection_info.algorithm.measurement_hash_algo = m_use_measurement_hash_algo;
    temp_buf_size = sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16) + MAX_SPDM_OPAQUE_DATA_SIZE;
    spdm_response = (void *)temp_buf;
    ...
    ptr = (void *)((uint8 *)spdm_response + sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo));
    // spdm_get_random_number (SPDM_NONCE_SIZE, ptr);
    // ptr += SPDM_NONCE_SIZE;
  ...
  case 0x18:
  {
    ...
    ((spdm_context_t*)spdm_context)->connection_info.algorithm.measurement_hash_algo = m_use_measurement_hash_algo;
    temp_buf_size = sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16) + (MAX_SPDM_OPAQUE_DATA_SIZE+1);
    spdm_response = (void *)temp_buf;
    ...
    // spdm_get_random_number (SPDM_NONCE_SIZE, ptr);
    // ptr += SPDM_NONCE_SIZE;
    *(uint16 *)ptr = (MAX_SPDM_OPAQUE_DATA_SIZE+1); // opaque_length
    ptr += sizeof(uint16);
  ...
  case 0x19:
  {
    ...
    ((spdm_context_t*)spdm_context)->connection_info.algorithm.bash_hash_algo = m_use_hash_algo;
    ((spdm_context_t*)spdm_context)->connection_info.algorithm.measurement_hash_algo = m_use_measurement_hash_algo;
    measurment_sig_size = SPDM_NONCE_SIZE + sizeof(uint16) + opaque_size_test + spdm_get_asym_signature_size (m_use_asym_algo);
    temp_buf_size = sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + measurment_sig_size;
    spdm_response = (void *)temp_buf;
  ...
  case 0x1A:
  {
    ...
    ((spdm_context_t*)spdm_context)->connection_info.algorithm.bash_hash_algo = m_use_hash_algo;
    ((spdm_context_t*)spdm_context)->connection_info.algorithm.measurement_hash_algo = m_use_measurement_hash_algo;
    measurment_sig_size = SPDM_NONCE_SIZE + sizeof(uint16) + (opaque_size_test - MissingBytes) + spdm_get_asym_signature_size (m_use_asym_algo);
    temp_buf_size = sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + measurment_sig_size;
    spdm_response = (void *)temp_buf;
  ...
  case 0x1D:
  {
    ...
    ((spdm_context_t*)spdm_context)->connection_info.algorithm.measurement_hash_algo = m_use_measurement_hash_algo;
    temp_buf_size = sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16) + opaque_size_test;
    spdm_response = (void *)temp_buf;
  ...
  case 0x1F:
  {
    ...
    ((spdm_context_t*)spdm_context)->connection_info.algorithm.measurement_hash_algo = m_use_measurement_hash_algo;
    temp_buf_size = sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + SPDM_NONCE_SIZE + sizeof(uint16) + opaque_size_test;
    spdm_response = (void *)temp_buf;
  ...
  case 0x20:
  {
    ...
    ((spdm_context_t*)spdm_context)->connection_info.algorithm.measurement_hash_algo = m_use_measurement_hash_algo;
    temp_buf_size = sizeof(spdm_measurements_response_t) + 2*(sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo));
    spdm_response = (void *)temp_buf;
    ...
    *(uint32 *)spdm_response->measurement_record_length = 2*((uint32)(sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo)));
    measurment_block = (void *)(spdm_response + 1);
    set_mem (measurment_block, 2*(sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo)), 1);
    measurment_block->Measurement_block_common_header.index = 1;
    measurment_block->Measurement_block_common_header.measurement_specification = SPDM_MEASUREMENT_BLOCK_HEADER_SPECIFICATION_DMTF;
    measurment_block->Measurement_block_common_header.measurement_size = (uint16) (sizeof(spdm_measurement_block_dmtf_header_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo));
    measurment_block = (void *)(((uint8*)measurment_block) + (sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo)));
...
void test_spdm_requester_get_measurements_case10(void **state) {
  ...
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, sizeof(spdm_message_header_t) + sizeof(spdm_measurements_response_t) + sizeof(uint16));
  free(data);
}
...
void test_spdm_requester_get_measurements_case11(void **state) {
  ...
  status = spdm_get_measurement (spdm_context, NULL, request_attribute, 1, 0, &number_of_block, &measurement_record_length, measurement_record);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, sizeof(spdm_message_header_t) + sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16));
  free(data);
}
...
void test_spdm_requester_get_measurements_case16(void **state) {
  ...
  for(int i=0; i<sizeof(SlotIDs)/sizeof(SlotIDs[0]); i++) {
    measurement_record_length = sizeof(measurement_record);
    spdm_context->transcript.message_m.buffer_size = 0;
    status = spdm_get_measurement (spdm_context, NULL, request_attribute, 1, SlotIDs[i], &number_of_block, &measurement_record_length, measurement_record);
...
void test_spdm_requester_get_measurements_case18(void **state) {
  ...
  status = spdm_get_measurement (spdm_context, NULL, request_attribute, 1, 0, &number_of_block, &measurement_record_length, measurement_record);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, sizeof(spdm_message_header_t) + sizeof(spdm_measurements_response_t) + LARGE_MEASUREMENT_SIZE);
  free(data);
}
...
void test_spdm_requester_get_measurements_case22(void **state) {
  ...
  for (NumberOfMessages = 1; NumberOfMessages <= TOTAL_MESSAGES; NumberOfMessages++) {
    ...
    if (status == RETURN_SUCCESS) {
      assert_int_equal (spdm_context->transcript.message_m.buffer_size, NumberOfMessages * (sizeof(spdm_message_header_t) + sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16)));
    } else {
      assert_int_equal (spdm_context->transcript.message_m.buffer_size, 0);
      break;
    }
...
void test_spdm_requester_get_measurements_case23(void **state) {
  ...
  status = spdm_get_measurement (spdm_context, NULL, request_attribute, 1, 0, &number_of_block, &measurement_record_length, measurement_record);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, sizeof(spdm_message_header_t) + sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16) + MAX_SPDM_OPAQUE_DATA_SIZE);
  free(data);
}
...
void test_spdm_requester_get_measurements_case24(void **state) {
  ...
  status = spdm_get_measurement (spdm_context, NULL, request_attribute, 1, 0, &number_of_block, &measurement_record_length, measurement_record);
  assert_int_equal (status, RETURN_SECURITY_VIOLATION);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, sizeof(spdm_message_header_t));
  free(data);
}
...
void test_spdm_requester_get_measurements_case26(void **state) {
  ...
  status = spdm_get_measurement (spdm_context, NULL, request_attribute, 1, 0, &number_of_block, &measurement_record_length, measurement_record);
  assert_int_equal (status, RETURN_DEVICE_ERROR);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, sizeof(spdm_get_measurements_request_t));
  free(data);
}
...
void test_spdm_requester_get_measurements_case29(void **state) {
  ...
  status = spdm_get_measurement (spdm_context, NULL, request_attribute, 1, 0, &number_of_block, &measurement_record_length, measurement_record);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, sizeof(spdm_message_header_t) + sizeof(spdm_measurements_response_t) +
                                                                  sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) +
...
void test_spdm_requester_get_measurements_case30(void **state) {
  ...
  status = spdm_get_measurement (spdm_context, NULL, request_attribute, 1, 0, &number_of_block, &measurement_record_length, measurement_record);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, sizeof(spdm_message_header_t) + sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16) + MAX_SPDM_OPAQUE_DATA_SIZE/2);
  free(data);
}
...
void test_spdm_requester_get_measurements_case31(void **state) {
  ...
  status = spdm_get_measurement (spdm_context, NULL, request_attribute, 1, 0, &number_of_block, &measurement_record_length, measurement_record);
  assert_int_equal (status, RETURN_DEVICE_ERROR);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, sizeof(spdm_message_header_t) + sizeof(spdm_measurements_response_t) + sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo) + sizeof(uint16) + MAX_UINT16);
  free(data);
}
...
void test_spdm_requester_get_measurements_case32(void **state) {
  ...
  measurement_record_length = sizeof(measurement_record);
  status = spdm_get_measurement (spdm_context, NULL, request_attribute, SPDM_GET_MEASUREMENTS_REQUEST_MEASUREMENT_OPERATION_ALL_MEASUREMENTS, 0, &number_of_block, &measurement_record_length, measurement_record);
  assert_int_equal (status, RETURN_SUCCESS);
  assert_int_equal (spdm_context->transcript.message_m.buffer_size, sizeof(spdm_message_header_t) + sizeof(spdm_measurements_response_t) + 2*(sizeof(spdm_measurement_block_dmtf_t) + spdm_get_measurement_hash_size (m_use_measurement_hash_algo)) + sizeof(uint16));
  free(data);
}
...
int spdm_requester_get_measurements_test_main(void) {
  ...
  return cmocka_run_group_tests(spdm_requester_get_measurements_tests, spdm_unit_test_group_setup, spdm_unit_test_group_teardown);
