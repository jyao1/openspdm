...
(*spdm_get_encap_response_func) (
  IN     void                 *spdm_context,
  IN     uintn                spdm_request_size,
  IN     void                 *spdm_request,
...
**/
return_status
spdm_generate_encap_extended_error_response (
  IN     void                 *spdm_context,
  IN     uint8                error_code,
  IN     uint8                error_data,
  IN     uintn                extended_error_data_size,
  IN     uint8                *extended_error_data,
  IN OUT uintn                *spdm_response_size,
     OUT void                 *spdm_response
  );
