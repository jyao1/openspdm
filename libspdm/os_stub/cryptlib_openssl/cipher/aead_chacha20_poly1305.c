  ...
  )
{
  ...
  ret_value = (boolean) EVP_EncryptInit_ex(ctx, EVP_chacha20_poly1305(), NULL, NULL, NULL);
  if (!ret_value) {
    goto done;
  }

  ret_value = (boolean) EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_AEAD_SET_IVLEN, (int32)iv_size, NULL);
  if (!ret_value) {
    goto done;
  }

  ret_value = (boolean) EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_AEAD_SET_TAG, (int32)tag_size, NULL);
  if (!ret_value) {
    goto done;
  }
  ...
  ret_value = (boolean) EVP_EncryptUpdate(ctx, NULL, (int32*)&temp_out_size, a_data, (int32)a_data_size);
  if (!ret_value) {
    goto done;
  }

  ret_value = (boolean) EVP_EncryptUpdate(ctx, data_out, (int32*)&temp_out_size, data_in, (int32)data_in_size);
  if (!ret_value) {
    goto done;
  }

  ret_value = (boolean) EVP_EncryptFinal_ex(ctx, data_out, (int32*)&temp_out_size);
  if (!ret_value) {
    goto done;
  }

  ret_value = (boolean) EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_AEAD_GET_TAG, (int32)tag_size, (void *)tag_out);
  ...
  )
{
  ...
  ret_value = (boolean) EVP_DecryptInit_ex(ctx, EVP_chacha20_poly1305(), NULL, NULL, NULL);
  if (!ret_value) {
    goto done;
  }
  ...
  ret_value = (boolean) EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_AEAD_SET_TAG, (int32)tag_size, (void *)tag);
  if (!ret_value) {
    goto done;
  }
  ...
  ret_value = (boolean) EVP_DecryptUpdate(ctx, NULL, (int32*)&temp_out_size, a_data, (int32)a_data_size);
  if (!ret_value) {
    goto done;
  }

  ret_value = (boolean)EVP_DecryptUpdate(ctx, data_out, (int32*)&temp_out_size, data_in, (int32)data_in_size);
  if (!ret_value) {
    goto done;
  }

  ret_value = (boolean) EVP_DecryptFinal_ex(ctx, data_out, (int32 *)&temp_out_size);
