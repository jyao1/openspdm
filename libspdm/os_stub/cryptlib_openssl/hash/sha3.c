  ...
  )
{
  ...
  md_ctx->md_data = (uint8*)sha3_256Context + sizeof (struct evp_md_ctx_st);
  ...
  )
{
  ...
  md_ctx->md_data = (uint8*)sha3_384_context + sizeof (struct evp_md_ctx_st);
  md_ctx->digest = evp_md;
  md_ctx->engine = NULL;
  md_st = (struct evp_md_st  *)evp_md;
  ...
  )
{
  ...
  md_ctx->md_data = (uint8*)sha3_512_context + sizeof (struct evp_md_ctx_st);
  md_ctx->digest = evp_md;
  md_ctx->engine = NULL;
  md_st = (struct evp_md_st  *)evp_md;
  ...
  )
{
  ...
  md_ctx->md_data = (uint8*)shake256_context + sizeof (struct evp_md_ctx_st);
  md_ctx->digest = evp_md;
  md_ctx->engine = NULL;
  md_st = (struct evp_md_st  *)evp_md;
