  ...
  )
{
  ...
  //
  return (boolean) (SHA384_Update ((SHA512_CTX *) sha384_context, data, data_size));
}
  ...
  )
{
  ...
  //
  return (boolean) (SHA384_Final (hash_value, (SHA512_CTX *) sha384_context));
}
  ...
  )
{
  ...
  //
  return (boolean) (SHA512_Update ((SHA512_CTX *) sha512_context, data, data_size));
}
  ...
  )
{
  ...
  //
  return (boolean) (SHA384_Final (hash_value, (SHA512_CTX *) sha512_context));
}
