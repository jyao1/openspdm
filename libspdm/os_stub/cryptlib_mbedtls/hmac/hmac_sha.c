  ...
  )
{
  ...
  ret = mbedtls_md_hmac (md_info, key, key_size, data, data_size, hmac_value);
  if (ret != 0) {
    return FALSE;
  }
  return TRUE;
...
{
  return hmac_md_set_key (MBEDTLS_MD_SHA256, hmac_sha256_ctx, key, key_size);
}
...
{
  return hmac_md_all (MBEDTLS_MD_SHA256, data, data_size, key, key_size, hmac_value);
}
...
{
  return hmac_md_set_key (MBEDTLS_MD_SHA384, hmac_sha384_ctx, key, key_size);
}
...
{
  return hmac_md_all (MBEDTLS_MD_SHA384, data, data_size, key, key_size, hmac_value);
}
...
{
  return hmac_md_set_key (MBEDTLS_MD_SHA512, hmac_sha512_ctx, key, key_size);
}
...
{
  return hmac_md_all (MBEDTLS_MD_SHA512, data, data_size, key, key_size, hmac_value);
}
